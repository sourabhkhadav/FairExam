...
const ExaminerDashboard = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-3xl border border-[#E2E8F0] shadow-sm mb-10">
                ...
                <div className="flex flex-wrap gap-4">
                    <button
                        ...
                        className="px-8 py-3.5 bg-[#4F46E5] text-white font-semibold text-[15px] rounded-xl hover:bg-[#4338CA] transition-colors shadow-sm cursor-pointer"
                    >
                        Create New Exam
                    </button>
            ...
            <div className="bg-white p-8 rounded-3xl border border-[#E2E8F0] shadow-sm overflow-x-auto">
                <h2 className="text-xl font-bold text-[#0F172A] mb-8">Recent Exams</h2>
                <table className="w-full">
                    <thead>
                        <tr className="text-left text-[#64748B] text-[13px] font-semibold">
                    ...
                    <tbody className="divide-y divide-[#F1F5F9]">
                        {recentExams.map((exam, i) => (
                            <tr key={i} className="group">
                                <td className="py-5 font-medium text-[#0F172A]">{exam.name}</td>
                                <td className="py-5 text-[#64748B]">{exam.date}</td>
                                <td className="py-5 text-[#64748B] text-center">{exam.students}</td>
